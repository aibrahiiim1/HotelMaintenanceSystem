        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsGuestRequest = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "OrderStatuses",
                columns: new[] { "Id", "IsFinal", "Name" },
                values: new object[,]
                {
                    { 1, false, "Created" },
                    { 2, false, "Awaiting Assignment" },
                    { 3, false, "Assigned" },
                    { 4, false, "Sent to Contractor" },
                    { 5, false, "Scheduled" },
                    { 6, false, "Completed" },
                    { 7, true, "Finalized" },
                    { 8, true, "Canceled" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpareParts_DepartmentId",
                table: "SpareParts",
                column: "DepartmentId");
